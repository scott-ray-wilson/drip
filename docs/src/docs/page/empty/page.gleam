...
import docs/page/empty/section/accessibility
import docs/page/empty/section/api_reference
import docs/page/empty/section/examples
import docs/page/empty/section/installation
import docs/page/empty/section/introduction
import docs/page/empty/section/usage
import docs/page/empty/section/variants
import drip/registry

// --- Page --------------------------------------------------------------------

pub fn page() -> ElementPage(message) {
  ElementPage(element: registry.empty, sections: [
    Section(
