...
import docs/page/checkbox/section/accessibility
import docs/page/checkbox/section/api_reference
import docs/page/checkbox/section/examples
import docs/page/checkbox/section/installation
import docs/page/checkbox/section/introduction
import docs/page/checkbox/section/usage
import drip/registry

// --- Page --------------------------------------------------------------------

pub fn page() -> ElementPage(message) {
  ElementPage(element: registry.checkbox, sections: [
    Section(
