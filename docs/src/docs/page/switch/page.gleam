...
import docs/page/switch/section/accessibility
import docs/page/switch/section/api_reference
import docs/page/switch/section/examples
import docs/page/switch/section/installation
import docs/page/switch/section/introduction
import docs/page/switch/section/usage
import drip/registry

// --- Page --------------------------------------------------------------------

pub fn page() -> ElementPage(message) {
  ElementPage(element: registry.switch, sections: [
    Section(
