...
import docs/page/table/section/accessibility
import docs/page/table/section/api_reference
import docs/page/table/section/examples
import docs/page/table/section/installation
import docs/page/table/section/introduction
import docs/page/table/section/usage
import drip/registry

// --- Page --------------------------------------------------------------------

pub fn page() -> ElementPage(message) {
  ElementPage(element: registry.table, sections: [
    Section(
