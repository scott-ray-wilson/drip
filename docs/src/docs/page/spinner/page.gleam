...
import docs/page/spinner/section/accessibility
import docs/page/spinner/section/api_reference
import docs/page/spinner/section/examples
import docs/page/spinner/section/installation
import docs/page/spinner/section/introduction
import docs/page/spinner/section/usage
import drip/registry

// --- Page --------------------------------------------------------------------

pub fn page() -> ElementPage(message) {
  ElementPage(element: registry.spinner, sections: [
    Section(
