...
import docs/page/button_group/example/introduction
import docs/ui/table_of_contents.{type Entry}
import lustre/element.{type Element}

// The page header renders at the page level (see button_group/page.gleam) so it
...
fn content() -> Block(message) {
  content.Example(code: button_group.introduction_html, body: [
    introduction.view(),
  ])
}
