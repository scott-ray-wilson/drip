...
import docs/page/switch/example/introduction
import docs/ui/table_of_contents.{type Entry}
import lustre/element.{type Element}

// The page header renders at the page level (see switch/page.gleam) so it can
...
fn content() -> Block(message) {
  content.Example(code: switch.introduction_html, body: [
    introduction.view(),
  ])
}
