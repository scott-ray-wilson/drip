...
import docs/page/card/section/accessibility
import docs/page/card/section/api_reference
import docs/page/card/section/examples
import docs/page/card/section/installation
import docs/page/card/section/introduction
import docs/page/card/section/usage
import drip/registry

// --- Page --------------------------------------------------------------------

pub fn page() -> ElementPage(message) {
  ElementPage(element: registry.card, sections: [
    Section(
