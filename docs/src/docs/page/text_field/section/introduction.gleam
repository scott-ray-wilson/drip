...
import docs/page/text_field/example/introduction
import docs/ui/table_of_contents.{type Entry}
import lustre/element.{type Element}

// The page header renders at the page level (see text_field/page.gleam) so it
...
fn content() -> Block(message) {
  content.Example(code: text_field.introduction_html, body: [
    introduction.view(),
  ])
}
