...
import docs/page/text_field/section/accessibility
import docs/page/text_field/section/api_reference
import docs/page/text_field/section/examples
import docs/page/text_field/section/installation
import docs/page/text_field/section/introduction
import docs/page/text_field/section/usage
import drip/registry

// --- Page --------------------------------------------------------------------

pub fn page() -> ElementPage(message) {
  ElementPage(element: registry.text_field, sections: [
    Section(
